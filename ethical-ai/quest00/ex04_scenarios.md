1. Interview: You're asked to explain a caching system design. What happens if you've always relied on AI to design systems?
  ...
  I will not be able to answer the question because there is nothing to say and the possibility of using AI at the interview is not there.


2. Production Bug: At 2 AM, you must debug code generated by AI months ago - but AI is offline. Can you fix it?

  There is no way I can debug the AI generated code at that time because it wasn't generated by me and I have no understanding of how it runs.
