1. #Interview: You're asked to explain a caching system design. What happens if you've always relied on AI to design systems?
  ...
  I will not be able to answer thge question because there is nothing to say and the possibility of using AI at the interview
  is not possible.


2. #Production Bug: At 2 AM, you must debug code generated by AI months ago - but AI is offline. Can you fix it?

  There is no way to way I can debug the AI generated code at that time because it wasn't generated by me and there is no
  understanding of how it runs.
...
#Reflection: Write one paragraph explaining how using AI fairly today prepares you for real-world challenges like these.
   ...
   AI fairly prepares me for real-world challenges like interview, production bug and learning a new learning by giving me in depth knowledge,
